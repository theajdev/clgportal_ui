...
const AdminNotice = () => {
  ...
  return (
    <div>
          ...
          <div className="card mt-4">
            <div className="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
              ...
              <div className="input-group ms-auto input-group-limit">
                ...
                <button type="button" className="btn btn-success dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-expanded="false" onClick={e => { }}>
      ...
      <div class="modal fade" id="ViewNotice" tabIndex="-1" aria-labelledby="ViewNoticeLable" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title fs-2 d-flex" id="ViewNoticeLable"><svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="currentColor" class="bi bi-megaphone me-1" viewBox="0 0 16 16">
                  ...
                  <section class="w-100 p-4 pb-4 d-flex justify-content-center">
                    <div style={{ "width": "22rem" }}>
                      <div class="text-center mb-4">
                        <h3 class="fw-bold">{notice.noticeTitle}</h3>
                      </div>
                      <p class="mb-4">{notice.noticeDesc}</p>
                      <div class="d-flex justify-content-between">
                        <p class=" mb-0">Status: {notice.status === 'V' ? (<span class="badge bg-success">Valid</span>) : (<span class="badge bg-danger">In-valid</span>)}</p>
