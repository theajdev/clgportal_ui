...
const AdminNotice = () => {
  ...
  return (
    <div className='ms-4'>
      ...
      <div class="modal fade" id="adminNoticeModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h1 class="modal-title fs-5" id="exampleModalLabel">New Admin Notice</h1>
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-primary">Save Admin Notice</button>
