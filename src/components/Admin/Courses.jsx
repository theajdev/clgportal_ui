...
const Cousres = () => {
  ...
  return (
    <div>
          ...
          <div className='mx-auto'>
            <div className="card mt-4">
              <div className="card-header">
                <button className='btn btn-primary' data-bs-toggle="modal" data-bs-target="#deptModal">Departments</button>
              </div>
      ...
      <div className="modal fade" id="deptModal" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h1 className="modal-title fs-5" id="exampleModalLabel">New Department</h1>
            ...
            <div className="modal-footer">
              <button type="button" className="btn btn-primary">Save Department</button>
